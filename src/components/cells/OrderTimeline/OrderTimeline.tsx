...
type OrderStatus = "received" | "prepared" | "shipped" | "delivered"
  ...
  return (
    <div className="w-full pt-6 pb-4">
      <div className="relative flex items-center justify-around">
        ...
        {/* Progress line */}
        <div
          className="absolute left-0 h-0.5 bg-[#f5f829] transition-all duration-300"
          style={{
            width:
              currentIndex >= 0
            ...
            >
              <span
                className={cn(
                  ...
                  isActive ? "text-[#f5f829]" : "text-[#EEEEEE]"
                )}
              >
                {status}
              </span>
