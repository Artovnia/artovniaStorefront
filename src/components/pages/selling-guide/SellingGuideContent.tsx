            ...
            <>
              ...
              <Disclosure.Panel className="pt-4 text-gray-700 space-y-4">
                <div>
                  ...
                  <p>
                    Kliknij w przycisk &ldquo;Twój sklep&rdquo; (lub ikonkę sklepu na urządeniach mobilnych) i wypełnij krótki formularz rejestracyjny. 
      ...
      <div className="mt-12 pt-8 border-t border-gray-200">
        <div className="bg-primary/5 border border-primary/20 rounded-md p-6 text-center">
          ...
          <p className="text-gray-700 mb-4">
            Kliknij w przycisk &ldquo;Twój sklep&rdquo; (lub ikonka sklepu na urządzeniach mobilnych), wypełnij formularz rejestracyjny i dołącz do społeczności twórców Artovni.
          </p>
